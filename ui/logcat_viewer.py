...
# Pure parsing/scanning helpers now live in ``ui.logcat.log_parsing``; they are
# re-exported here so existing ``from ui.logcat_viewer import LogLine`` (and the
# private helpers used by tests) keep working (god-file split, #61).
from ui.logcat.log_parsing import (  # noqa: E402
    LogLine,
